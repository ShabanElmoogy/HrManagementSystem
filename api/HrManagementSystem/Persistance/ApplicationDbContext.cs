...
namespace HrManagementSystem.Persistance;
...

{
    ...
    public DbSet<KanbanBoardMember> KanbanBoardMembers { get; set; }
    public DbSet<KanbanColumn> KanbanColumns { get; set; }
    public DbSet<KanbanCard> KanbanCards { get; set; }
    public DbSet<KanbanCardAssignee> KanbanCardAssignees { get; set; }
    public DbSet<KanbanLabel> KanbanLabels { get; set; }
    public DbSet<KanbanCardLabel> KanbanCardLabels { get; set; }
    public DbSet<KanbanCardComment> KanbanCardComments { get; set; }
    public DbSet<KanbanCardAttachment> KanbanCardAttachments { get; set; }
    // Kanban Tasks
    public DbSet<BoardTask> BoardTasks { get; set; }
    public DbSet<BoardTaskAttachment> BoardTaskAttachments { get; set; }

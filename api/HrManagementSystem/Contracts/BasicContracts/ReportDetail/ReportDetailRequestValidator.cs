...
{
    public class ReportMasterRequestValidator : AbstractValidator<ReportDetailRequest>
    {
        private readonly ApplicationDbContext _dbContext;
        private readonly IStringLocalizer<ReportDetailRequest> _localizer;

        public ReportMasterRequestValidator(ApplicationDbContext dbContext, IStringLocalizer<ReportDetailRequest> localizer)
        {

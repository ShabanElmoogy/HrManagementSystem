...
{
    public class ReportDetailRequestValidator : AbstractValidator<ReportCategoryRequest>
    {
        private readonly ApplicationDbContext _dbContext;
        private readonly IStringLocalizer<ReportCategoryRequest> _localizer;

        public ReportDetailRequestValidator(ApplicationDbContext dbContext, IStringLocalizer<ReportCategoryRequest> localizer)
        {

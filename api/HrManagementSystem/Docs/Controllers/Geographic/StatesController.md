...
**Permission:** `ViewStates`  
**Description:** Returns a state with its full districts list populated.  
Use this when you need to show the districts dropdown for a specific state.

**Response 200:** StateResponse with `districts` array populated.
...
**Response 201:** Returns the updated state.
